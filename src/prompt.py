...
PROMPTS[
    "community_report"
] = """You are a helpful legal expert that helps a human analyst to perform general information discovery from contract documents. 
...
- TITLE: community's name that represents its key entities - title should be short but specific to contact documents. When possible, include representative named entities in the title.
...
4. Only Extract entity_name from the provided text exactly as it appears, without any modification.
...
] = """You are a helpful legal expert responsible for generating a comprehensive summary of the data provided below.
...
You are a helpful legal expert responding to questions about data in the tables provided.
...
You are a helpful legal expert responding to questions about a dataset by synthesizing perspectives from multiple analysts.
